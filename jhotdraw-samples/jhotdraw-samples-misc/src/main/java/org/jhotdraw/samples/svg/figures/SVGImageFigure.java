...
public class SVGImageFigure extends SVGAttributedFigure implements SVGFigure, ImageHolderFigure {
    ...
    AbstractAction setToImageSizeAction = new AbstractAction(labels.getString("edit.setToImageSize.text")) {
        private static final long serialVersionUID = 1L;
    ...
    AbstractAction adjustHeightToImageAspectAction = new AbstractAction(labels.getString("edit.adjustHeightToImageAspect.text")) {
        private static final long serialVersionUID = 1L;
    ...
    AbstractAction adjustWidthToImageAspectAction = new AbstractAction(labels.getString("edit.adjustWidthToImageAspect.text")) {
        private static final long serialVersionUID = 1L;
    ...
    public Collection<Action> getActions(Point2D.Double p) {
        ...
        if (bufferedImage != null) {
            if (rectangle.width != bufferedImage.getWidth()
                ...
                actions.add(setToImageSizeAction);
            }
            ...
            if (Math.abs(imageRatio - figureRatio) > 0.001) {
                actions.add(adjustHeightToImageAspectAction);
                actions.add(adjustWidthToImageAspectAction);
            }
        }
        return actions;
    }
